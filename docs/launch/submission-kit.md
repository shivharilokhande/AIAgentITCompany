...
**Alternatives to position against (for "alternative to" fields):** CrewAI Studio, AutoGen Studio, Devin, OpenHands, ChatDev

**Maker one‑liner:** Built by Shivhari Lokhande — it runs a production restaurant‑POS SaaS and a trading‑desk project today.

## Awesome lists

| List | Status | Notes |
|---|---|---|
| e2b-dev/awesome-ai-agents | ✅ PR [#1636](https://github.com/e2b-dev/awesome-ai-agents/pull/1636) | Open‑source section, alphabetical |
| unicodeveloper/awesome-nextjs | ✅ PR [#613](https://github.com/unicodeveloper/awesome-nextjs/pull/613) | Apps section |
| hesreallyhim/awesome-claude-code | ⏳ eligible ~9 Oct 2026 | Needs 14 days of history (or 100 ⭐); submit via their **issue form**, one resource only |
| awesome-selfhosted | ⏳ eligible ~late Jan 2027 | Needs first release > 4 months old; **must be submitted by a human** (they reject LLM submissions) |
| Shubhamsaboo/awesome-llm-apps | ✖ not a fit | Lists apps hosted inside their repo |
| awesome-ollama / awesome-local-ai lists | 🔲 to do | Search GitHub for the currently maintained one; PR the Ollama‑engine angle |
| awesome-mcp-servers | 🔲 after MCP server ships | Exposing the bridge as an MCP server unlocks this and the MCP registries |

## Directories (need your login — paste the copy above)

| Directory | URL | Why | Status |
|---|---|---|---|
| There's An AI For That (TAAFT) | https://theresanaiforthat.com/submit/ | Highest‑traffic AI directory; dofollow | 🔲 |
| Futurepedia | https://www.futurepedia.io/submit-tool | Big AI directory | 🔲 |
| AlternativeTo | https://alternativeto.net/manage-item/ | "Alternative to CrewAI Studio / AutoGen Studio / OpenHands" pages rank well | 🔲 |
| SaaSHub | https://www.saashub.com/submit | Free, fast approval, dofollow | 🔲 |
| Product Hunt | https://www.producthunt.com/posts/new | Launch day only — see launch plan | 🔲 |
| BetaList | https://betalist.com/submit | Good for early‑stage; free tier is slow | 🔲 |
| Hacker News (Show HN) | https://news.ycombinator.com/submit | Launch day — see post below | 🔲 |
| Dev Hunt | https://devhunt.org | Dev‑tool specific weekly launch | 🔲 |
| Uneed | https://www.uneed.best/submit-a-tool | Daily launch, free option | 🔲 |
| OpenAlternative | https://openalternative.co/submit | Open‑source alternatives directory — perfect fit | 🔲 |
| Selfh.st / awesome‑selfhosted apps | https://selfh.st/apps/ | Self‑hosted community | 🔲 |
| GitHub Explore / Trending | — | Automatic; driven by stars in 24h window — concentrate launch traffic | — |
...
What's different from a script of agents: the process is data, not prompts. Ten SOPs fix the shape of each hand‑off (PRD → system design → task plan, with a consistency gate that refuses to start coding until file list == logic analysis == task list), every file gets an LGTM/LBTM review, and a 10‑check quality gate has to pass before "deploy". The scrum board has real sprints, burndown, parallel lanes, and you can "hire" more engineer agents.

The engine is pluggable. It can ride on the Claude desktop app (it tails Cowork's local session logs and mirrors them — no API key), call Anthropic / OpenAI incl. Codex / Gemini / OpenRouter with a key, or run fully offline on Ollama. I use it daily to run a restaurant‑POS SaaS.
...
**Tagline:** Run an AI software company from your browser
**First comment:** the Show HN text, trimmed to 4 short paragraphs, ending with what you want feedback on.

## Launch‑week checklist

- [ ] Day 0 (Tue–Thu, 8–9 am ET): Show HN + r/LocalLLaMA + r/ClaudeAI + LinkedIn/X within the same hour
- [ ] Be in the HN thread for 2 hours; answer every question; fix anything surfaced same day and push
- [ ] Day 1: TAAFT, Futurepedia, SaaSHub, OpenAlternative, AlternativeTo, Uneed, Dev Hunt submissions
- [ ] Day 3–5: Product Hunt launch (after HN feedback is folded in)
- [ ] Day 7: tag v2.3.0 with release notes crediting contributors; post the deep‑dive "how the Session Watcher works"
- [ ] ~9 Oct: submit to awesome‑claude‑code via issue form
